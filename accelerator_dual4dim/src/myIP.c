...
#pragma SDS data buffer_depth(data0buf:16, data1buf:4, data2buf:4, r:4)

void myFuncAccel (unsigned int size, unsigned int dim, dataType_t threshold, dataType_t * data0, dataType_t * data1, dataType_t * data2, unsigned int offset)
{
	unsigned int i, k, l;
